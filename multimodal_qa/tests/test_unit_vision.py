...
class TestGeminiVision:
    ...
    @patch("app.services.vision.gemini_vision.genai")
    @patch("app.services.vision.utils.PIL.Image.open")
    ...
    def test_describe_image_rgba_converts_to_rgb(self, mock_pil_open, mock_genai):
        ...
        mock_genai.GenerativeModel.return_value = mock_model
        mock_genai.configure = MagicMock()
        with patch("app.services.vision.utils.PIL.Image.new", return_value=mock_bg):
            gv = GeminiVision()
