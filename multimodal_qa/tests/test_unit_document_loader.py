...
class TestDocumentLoader:
    ...
    def test_load_documents_pdf(self, tmp_path):
        ...
        with patch("app.services.rag.document_loader.ParserFactory.get_parser", return_value=mock_parser):
    ...
    def test_load_multiple_files(self, tmp_path):
        ...
        with patch("app.services.rag.document_loader.ParserFactory.get_parser", side_effect=mock_get_parser):
