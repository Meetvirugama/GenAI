...
@patch("app.services.agent.workflow.Config.GROQ_API_KEYS", ["fake"])
@patch("app.services.agent.workflow.Config.GEMINI_API_KEY", "fake")
...
@patch("app.services.tools.document.get_search_tool")
