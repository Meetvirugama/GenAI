...
class TestDocumentEnricher:
    ...
    @patch("app.services.rag.enrichment.ChatGroq")
    def test_enrich_chunk_success(self, mock_groq):
        """Should enrich a document chunk with summary and keywords."""
        from app.services.rag.enrichment import ChunkMetadata, DocumentEnricher
...
class TestChunkMetadataModel:
    def test_chunk_metadata_creation(self):
        from app.services.rag.enrichment import ChunkMetadata
        meta = ChunkMetadata(
