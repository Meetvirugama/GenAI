...
- **Upload Size Limits:** The backend handles file uploads safely. Large PDFs are streamed directly to the Gemini API, preventing local server memory exhaustion.
