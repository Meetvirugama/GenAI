...
class TestGetRetriever:
    ...
    def test_get_retriever_no_db_returns_none(self, mock_config):
        ...
        with patch("app.rag.vector_store.Chroma", side_effect=Exception("DB error")):
            with patch("app.rag.vector_store.HuggingFaceEmbeddings"):
                with patch("app.rag.vector_store.LocalFileStore"):
                    with patch("app.rag.vector_store.CacheBackedEmbeddings"):
    ...
    def test_get_retriever_invalid_strategy_defaults_to_dense(self, mock_config):
        ...
        with patch("app.rag.vector_store.RetrieverFactory.get_retriever") as mock_factory:
